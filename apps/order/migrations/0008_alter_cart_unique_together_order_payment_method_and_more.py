...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('order', '0007_alter_cartitem_unique_together_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='order',
            name='payment_method',
            field=models.CharField(choices=[('CC', 'Credit Card'), ('DC', 'Debit Card'), ('PP', 'PayPal'), ('GP', 'Google Pay'), ('AP', 'Apple Pay'), ('BT', 'Bank Transfer'), ('COD', 'Cash on Delivery'), ('BTC', 'Bitcoin'), ('ETH', 'Ethereum'), ('CA', 'Cash')], default='', max_length=24, verbose_name='Payment Method'),
